...
public final class CloudChannelServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.channel.v1.ImportCustomerRequest,
      com.google.cloud.channel.v1.Customer> getImportCustomerMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      responseType = com.google.cloud.channel.v1.Customer.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.channel.v1.ImportCustomerRequest,
      com.google.cloud.channel.v1.Customer> getImportCustomerMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.channel.v1.ImportCustomerRequest, com.google.cloud.channel.v1.Customer> getImportCustomerMethod;
      ...
      synchronized (CloudChannelServiceGrpc.class) {
        if ((getImportCustomerMethod = CloudChannelServiceGrpc.getImportCustomerMethod) == null) {
          CloudChannelServiceGrpc.getImportCustomerMethod = getImportCustomerMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.channel.v1.ImportCustomerRequest, com.google.cloud.channel.v1.Customer>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public static abstract class CloudChannelServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void importCustomer(com.google.cloud.channel.v1.ImportCustomerRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.channel.v1.Customer> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getImportCustomerMethod(), responseObserver);
    }
  ...
  public static final class CloudChannelServiceStub extends io.grpc.stub.AbstractAsyncStub<CloudChannelServiceStub> {
    ...
    public void importCustomer(com.google.cloud.channel.v1.ImportCustomerRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.channel.v1.Customer> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getImportCustomerMethod(), getCallOptions()), request, responseObserver);
    }
  ...
  public static final class CloudChannelServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CloudChannelServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.cloud.channel.v1.Customer importCustomer(com.google.cloud.channel.v1.ImportCustomerRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CloudChannelServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CloudChannelServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.channel.v1.Customer> importCustomer(
