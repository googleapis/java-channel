...
public class CloudChannelServiceClient implements BackgroundResource {
   ...
   *       different.
   *   <li> NOT_FOUND: The
   *       [CustomerRepricingConfig][google.cloud.channel.v1.CustomerRepricingConfig] was not found.
   ...
   *       different.
   *   <li> NOT_FOUND: The
   *       [CustomerRepricingConfig][google.cloud.channel.v1.CustomerRepricingConfig] specified does
   *       not exist or is not associated with the given account.
   *   <li> INTERNAL: Any non-user error related to technical issues in the backend. In this case,
   *       contact Cloud Channel support.
   * </ul>
   *
   ...
   *
   * <ul>
   *   <li> This functionality is reserved for recovering from an erroneous config, and should not
   *       be used for regular business cases.
   *   <li> The new config will not modify exports used with other configs. Changes to the config
   *       may be immediate, but may take up to 24 hours.
   ...
   *   <li> PERMISSION_DENIED: If the account making the request and the account being queried are
   *       different.
   *   <li> INVALID_ARGUMENT: Missing or invalid required parameters in the request. Also displays
   *       if the updated config is for the current month or past months.
   *   <li> NOT_FOUND: The
   *       [CustomerRepricingConfig][google.cloud.channel.v1.CustomerRepricingConfig] specified does
   *       not exist or is not associated with the given account.
   *   <li> INTERNAL: Any non-user error related to technical issues in the backend. In this case,
  ...
  public static class ListCustomerRepricingConfigsPagedResponse
      extends AbstractPagedListResponse<
          ListCustomerRepricingConfigsRequest, ListCustomerRepricingConfigsResponse,
          CustomerRepricingConfig, ListCustomerRepricingConfigsPage,
  ...
  public static class ListChannelPartnerRepricingConfigsPagedResponse
      extends AbstractPagedListResponse<
          ListChannelPartnerRepricingConfigsRequest, ListChannelPartnerRepricingConfigsResponse,
          ChannelPartnerRepricingConfig, ListChannelPartnerRepricingConfigsPage,
